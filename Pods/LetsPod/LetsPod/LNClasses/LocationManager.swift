...
class LocationManager: NSObject,CLLocationManagerDelegate {
    ...
    /* variables */
    var completionHandler:LMLocationCompletionHandler
    
    var reverseGeocodingCompletionHandler:LMReverseGeocodeCompletionHandler
    var geocodingCompletionHandler:LMGeocodeCompletionHandler
    
    var locationStatus : NSString = "Calibrating"// to pass in handler
    var locationManager: CLLocationManager!
    var verboseMessage = "Calibrating"
    
    let verboseMessageDictionary = [CLAuthorizationStatus.notDetermined:"You have not yet made a choice with regards to this application.",
    ...
    func geoCodeUsignGoogleAddress(_ address:NSString){
    ...
    func reverseGocodeUsingGoogle(latitude:Double, longitude: Double){
    ...
    func performOperationForURL(_ urlString:NSString,type:GeoCodingType){
    ...
    func setCompletionHandler(responseInfo:NSDictionary?,placemark:CLPlacemark?, error:String?,type:GeoCodingType){
...
class AddressParser: NSObject{
    ...
    var administrativeAreaCode = NSString()
    var subAdministrativeArea = NSString()
    var postalCode = NSString()
    var country = NSString()
    var subThoroughfare = NSString()
    var thoroughfare = NSString()
    var ISOcountryCode = NSString()
    var state = NSString()
    ...
    func parseAppleLocationData(_ placemark:CLPlacemark){
    ...
    open func parseGoogleLocationData(_ resultDict:NSDictionary){
    ...
    func component(_ component:NSString,inArray:NSArray,ofType:NSString) -> NSString {
        let index = inArray.indexOfObject(options: NSEnumerationOptions.concurrent) { (obj, idx, stop) -> Bool in
